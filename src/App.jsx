...
const STORAGE_KEY = "finance_meta_ai_generator_safe_v2";
...
function createVideoPack(nicheName, language) {
  ...
  const scenes = lines.map((line, index) => {
    ...
    const imageScenes = {
      "Crypto Finance": [
        "Vertical 9:16 image. Same black stick figure guy holding phone close to face. Green crypto chart glowing on phone screen. Dark bedroom. Blue screen light on face. Shocked white eyes. 2D cartoon finance style. No text.",
        "Vertical 9:16 image. Same black stick figure guy sitting at messy desk with laptop open. Crypto candles on laptop screen. Small digital coin shapes around table. Nervous mood. Dark cinematic room. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy watching red crypto chart crash on phone. Red glow fills the room. Shoulders dropped. Panic emotion. Dark finance background. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy staring at phone while chat bubble shapes fade away. Night city window behind him. Lonely mood. Neon blue and red lighting. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy writing risk rules in notebook beside laptop. Dim yellow desk lamp. Calm focused mood. Crypto chart visible on laptop. 2D cartoon finance style. No text.",
        "Vertical 9:16 image. Same black stick figure guy closing laptop calmly. Dark room with soft blue light. Crypto chart no longer visible. Relief emotion. 2D cartoon finance style. No text.",
        "Vertical 9:16 image. Same black stick figure guy walking away from floating crypto coin symbols. Dark street. Digital coins fading behind him. Strong decision mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy standing still while red chart falls behind him. Dark finance background. Calm face. High contrast. 2D cartoon style. No text."
      ],
      "Business Stories": [
        "Vertical 9:16 image. Same black stick figure guy standing inside a small busy shop. Shelves and boxes behind him. Warm shop lights. Curious mood. 2D cartoon business style. No text.",
        "Vertical 9:16 image. Same black stick figure guy opening cash drawer with very little money inside. Shop counter. Receipt paper and delivery boxes nearby. Worried emotion. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy counting bills beside stacked delivery boxes. Small business shop background. Evening light. Stressful money mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy checking expense notebook with calculator. Shop lights behind him. Head slightly down. Financial pressure mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy crossing out a bad discount offer on paper. Small shop wall behind. Determined mood. 2D cartoon business style. No text.",
        "Vertical 9:16 image. Same black stick figure guy looking at positive cashflow line on laptop. Organized counter with notebook and bills. Hopeful mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy arranging money, stock boxes, and notebook neatly. Clean shop counter. Relief emotion. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy locking cash drawer confidently. Small shop closing time. Golden warm light. Success mood. 2D cartoon style. No text."
      ],
      "Stock Market": [
        "Vertical 9:16 image. Same black stick figure guy watching green stock chart rise on laptop. Dark desk setup. Excited white eyes. 2D cartoon finance style. No text.",
        "Vertical 9:16 image. Same black stick figure guy shocked as one red candle appears on laptop chart. Red light on face. Nervous mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy holding head while stock graph falls. Phone alerts glowing nearby. Dark office desk. Regret mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy writing investing plan in notebook beside laptop. Calm blue light. Focused mood. 2D cartoon finance style. No text.",
        "Vertical 9:16 image. Same black stick figure guy ignoring hype notifications on phone. Floating notification shapes fading. Dark room. Disciplined mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy studying chart calmly with notebook open. Quiet night window. Patient mood. 2D cartoon finance style. No text.",
        "Vertical 9:16 image. Same black stick figure guy sitting steady while green and red chart lines move behind him. Calm emotion. Minimal dark market background. No text.",
        "Vertical 9:16 image. Same black stick figure guy standing beside simple rising graph. Soft green glow. Confident mood. 2D cartoon style. No text."
      ],
      "Debt & Credit": [
        "Vertical 9:16 image. Same black stick figure guy holding credit card in dark room. Phone payment screen glowing. Unsure emotion. 2D cartoon finance style. No text.",
        "Vertical 9:16 image. Same black stick figure guy worried at payment bill on phone. Small apartment desk with bills around. Stress mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy surrounded by growing interest number shapes. Red warning glow. Paper bills around him. Fear emotion. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy pushing credit card away on desk. Wallet and bill paper nearby. Determined mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy listing debts in notebook. Calculator and lamp on desk. Focused mood. 2D cartoon finance style. No text.",
        "Vertical 9:16 image. Same black stick figure guy paying one bill on phone. One paper bill fading away. Warm light. Relief emotion. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy closing wallet calmly after organizing money. Clean desk. Fewer bills. Peaceful mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy walking away from floating debt papers. Dark hallway. Papers fading into shadows. Freedom mood. No text."
      ],
      "Rich Mindset": [
        "Vertical 9:16 image. Same black stick figure guy looking at expensive item on phone. Dark room. Finger paused before buying. Thinking mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy walking past flashy shopping signs. Night mall corridor. Signs glowing behind him. Discipline mood. No text.",
        "Vertical 9:16 image. Same black stick figure guy dropping coins into savings jar. Simple desk. Soft lamp. Small wealth habit mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy choosing laptop asset graph over shopping bag. Split desk scene. Smart decision mood. No text.",
        "Vertical 9:16 image. Same black stick figure guy writing wealth plan in notebook. Clean desk. Dark blue light. Focused mindset mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy standing beside growing asset chart on laptop. Calm confident mood. Minimal dark room. No text.",
        "Vertical 9:16 image. Same black stick figure guy sitting peacefully in simple room. Morning light. Notebook nearby. Quiet wealth mood. 2D cartoon style. No text.",
        "Vertical 9:16 image. Same black stick figure guy watching sunrise from rooftop. City skyline. Confident ending mood. 2D cartoon style. No text."
      ]
    };

    const imagePrompt = (imageScenes[niche.name] || imageScenes["Crypto Finance"])[index % TOTAL_SCENES];
...
const UI = {
  ...
  select: { width: "100%", background: "#020617", border: "1px solid #334155", color: "white", borderRadius: "16px", padding: "14px", fontSize: "15px", outline: "none" },
  generate: { width: "100%", height: "100%", minHeight: "82px", border: "none", borderRadius: "24px", background: "linear-gradient(135deg, #facc15, #fb923c)", color: "#111827", fontSize: "18px", fontWeight: 950, cursor: "pointer", boxShadow: "0 18px 40px rgba(250,204,21,0.28)" },
  section: { background: "rgba(15,23,42,0.82)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "28px", padding: "22px", marginBottom: "22px", boxShadow: "0 20px 60px rgba(0,0,0,0.35)" },
